<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperMasterPage.master" AutoEventWireup="true" CodeFile="SuperMessage.aspx.cs" Inherits="SuperAdmin_Message" %>
                                    ...
                                    <div class="widget-title">
                                        ...
                                        <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" CellPadding="10" BorderColor="White" DataKeyNames="ID" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting">
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnDelete" OnClientClick="return confirm('Are U Sure');" runat="server" CommandName="Delete" CommandArgument='<%#Eval("ID") %>' Text="Delete" CssClass="btn btn-danger" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                    ...
                                    <div class="widget-title">
                                        ...
                                        <asp:GridView ID="GridView2" OnRowDeleting="GridView1_RowDeleting" AutoGenerateColumns="False" runat="server" CellPadding="10" BorderColor="White" DataKeyNames="ID" OnRowDataBound="GridView2_RowDataBound" OnRowCommand="GridView2_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnDelete" OnClientClick="return confirm('Are U Sure');" runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="Delete" Text="Delete" CssClass="btn btn-danger" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="pnlReply" runat="server" Visible="false">
                                        ...
                                        <div class="controls">
                                            <asp:TextBox ID="txtReply" ValidationGroup="g" MaxLength="200" TextMode="MultiLine" Width="280px" placeholder="Enter Your Message Here..." runat="server" Rows="5"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="**" Display="Dynamic" ValidationGroup="g" ForeColor="Red" ControlToValidate="txtReply"></asp:RequiredFieldValidator>
                                        </div>
                                        <br />
                                        <div class="controls">
                                            <asp:Button ID="Button3" runat="server" Text="Send" ValidationGroup="g" OnClick="Button3_Click" CssClass="btn btn-success" />
