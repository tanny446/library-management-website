...
public partial class SuperAdmin_Message : System.Web.UI.Page
{
    ...
    private void DropDownOrg()
    {
        ...
        cmd.Parameters.AddWithValue("@recieverid", Session["super"]);
    ...
    private void bindOutbox()
    {
        ...
        cmd.Parameters.AddWithValue("@senderid", Session["super"]);
        SqlDataReader dr = cmd.ExecuteReader();
        DataTable dt = new DataTable();
        dt.Load(dr);
        cn.Close();
